...
<!-- <div class="bg-white dark:bg-base-200 p-8 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700"> -->
  <h2 class="text-3xl font-bold text-black mb-8">About Me</h2>
  <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
    <!-- Card 1 -->
    <div class="flex gap-4 items-start px-4">
      <div>
        <h3 class="text-xl font-semibold text-black">Software Development</h3>
    ...
    <div class="flex gap-4 items-start px-4">
      <div>
        <h3 class="text-xl font-semibold text-black">Web Development</h3>
    ...
    <div class="flex gap-4 items-start px-4">
      <div>
        <h3 class="text-xl font-semibold text-black">Agile Methodology</h3>
